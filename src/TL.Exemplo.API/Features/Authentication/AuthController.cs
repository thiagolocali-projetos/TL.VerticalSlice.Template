...
using TL.Exemplo.Application.Features.Authentication.Refresh;
using TL.Exemplo.Application.Features.Authentication.Logout;

namespace TL.Exemplo.API.Features.Authentication;
