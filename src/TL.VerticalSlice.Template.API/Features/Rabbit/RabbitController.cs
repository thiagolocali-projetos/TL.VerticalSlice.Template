...
using TL.VerticalSlice.Template.Application.Features.Rabbit.ConsumirMensagem;
using TL.VerticalSlice.Template.Application.Features.Rabbit.ProduzirMensagem;

namespace TL.VerticalSlice.Template.API.Features.Rabbit;
