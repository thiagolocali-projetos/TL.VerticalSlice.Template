...
/// <summary>
/// Envelope de resposta genÃ©rico para todos os endpoints da API.
/// </summary>
public sealed class ApiResponse<T>
{
    ...
    // Construtor interno â€” use os factory methods abaixo
    ...
    public static ApiResponse<T> NaoEncontrado(string mensagem = "Recurso nÃ£o encontrado.")
        => new() { Sucesso = false, Mensagem = mensagem };
}

/// <summary>
/// Factory estÃ¡tica para respostas sem dado de retorno (object vazio).
/// NÃ£o herda de ApiResponse&lt;T&gt; para evitar conflitos de membros.
/// </summary>
public static class ApiResponse
{
    public static ApiResponse<object> Ok(string mensagem = "OperaÃ§Ã£o realizada com sucesso.")
    ...
    public static ApiResponse<object> NaoEncontrado(string mensagem = "Recurso nÃ£o encontrado.")
