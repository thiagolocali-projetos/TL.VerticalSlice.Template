...
namespace TL.VerticalSlice.Template.Tests.Features.Authentication;
...
public class LoginCommandTests
{
    ...
    public async Task Handle_WithValidCredentials_ShouldReturnToken()
    {
        ...
        _refreshTokenRepositoryMock
            .Setup(x => x.CreateAsync(It.IsAny<TL.VerticalSlice.Template.Domain.Entities.RefreshToken>()))
            .ReturnsAsync(1);
